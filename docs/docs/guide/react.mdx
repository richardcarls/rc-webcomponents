...
Register the elements you use once in your application entry point. Prefer the
aggregate package's per-component subpaths so unused components stay out of the
bundle:
