...
```js
import '@rcarls/rc-webcomponents/rc-carousel/define';
```
...
Because the token is pure track geometry, a consumer container query can adapt
it without changing carousel state, keyboard behavior, or accessibility:
