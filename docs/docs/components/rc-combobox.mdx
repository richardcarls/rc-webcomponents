...
On Firefox for Android (GeckoView), tapping anywhere within an ancestor `<label>`'s rendered "Geckoview and Fennec open select dropdown on tap of parent label; other browsers do not."  [Bugzilla 1475723](https://bugzilla.mozilla.org/show_bug.cgi?id=1475723)
