...
The unthemed card is an undecorated content container. Apply a packaged theme
or card tokens when the composition needs padding, shape, elevation, or state
layers.
...
Consumers can use subgrid on the host to align repeated cards across a parent
grid.
