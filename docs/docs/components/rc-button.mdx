...
Substrate supplies hover, focus, and pressed state layers. Material supplies
the same interaction states and adds a reduced-motion-aware ripple originating
at the pointer or touch position.
