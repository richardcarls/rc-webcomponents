...
| [`rc-card`](packages/rc-card/)                                         | Design-system-neutral vertical and horizontal card shell with slots, parts, grid coordination, and optional action-target click forwarding                                                                      | None                               |
